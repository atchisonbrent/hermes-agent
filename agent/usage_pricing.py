...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # cache reads reduced to 2.5% of base input ($0.25/MTok). Hermes currently
    # records one cache-write bucket and emits standard 5-minute cache writes;
    # 1-hour cache writes ($20/MTok) would require a distinct usage bucket.
